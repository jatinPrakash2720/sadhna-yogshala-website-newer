...
/**
 * Pricing Section — price and discount only (schedule fields live in ScheduleSection).
 */
  ...
  return (
    <div className="space-y-5">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
          ...
          <div className="relative">
            <span className="absolute left-3 top-1/2 -translate-y-1/2 text-sm font-medium text-sage-400">₹</span>
            <input
      ...
      <div className="flex items-start gap-3 rounded-xl border border-brand-200 bg-brand-50 p-4">
        ...
        <div>
          <p className="text-sm font-medium text-brand-800">Google Meet for live classes</p>
          <p className="mt-1 text-xs text-brand-700/80">
            Meet links are generated when you save the draft with calendar links on the final step.
          </p>
        </div>
      </div>
    </div>
