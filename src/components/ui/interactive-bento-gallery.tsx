...
const GalleryModal = ({
  ...
  return (
    <>
      ...
      >
        <motion.div className="relative rounded-xl bg-primary/20 backdrop-blur-xl border border-primary/30 shadow-lg cursor-grab active:cursor-grabbing">
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      <div className="mb-12 text-center">
        <motion.h1
          className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold text-primary"
        ...
        <motion.p
          className="mt-3 text-base sm:text-lg text-secondary"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
      ...
      <AnimatePresence mode="wait">
        {selectedItem ? (
          ...
          <motion.div
            className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-4 md:gap-6 auto-rows-[100px] md:auto-rows-[120px]"
            initial="hidden"
            animate="visible"
            exit="hidden"
            variants={{
              ...
              >
                ...
                >
                  <div className="absolute inset-0 flex flex-col justify-end p-3 sm:p-4 md:p-6">
                    ...
                    <h3 className="relative text-white text-sm sm:text-base md:text-lg font-medium line-clamp-1">
                      {item.title}
                    </h3>
